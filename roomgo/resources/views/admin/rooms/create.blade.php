                        ...
                        <div class="card-body p-4 p-lg-5 text-black">
                            <form method="POST" action="{{ route('rooms.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="d-flex align-items-center pb-0 mb-3">
                                    <span class="h1 fw-bold mb-0">Create Room for Host</span>
                                </div>

                                <div class="form-outline mb-1">
                                    <input type="email" id="host_email" class="form-control form-control-md @error('host_email') is-invalid @enderror" name="host_email" value="{{ old('host_email') }}" required />
                                    <label class="form-label mt-2 mx-2" for="host_email">Host Email</label>
                                    @error('host_email')
