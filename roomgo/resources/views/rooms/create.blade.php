                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                        <div class="card-body p-4 p-lg-5 text-black">
                            <form method="POST" action="{{ route('rooms.stores') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-outline mb-1">
                                    <input id="city" type="text" style="color: #9A616D;" class="form-control form-control-md @error('city') is-invalid @enderror" name="city" value="{{ old('city') }}" required />
                                    <label class="form-label mt-2 mx-2" style="color: #9A616D;" for="city">City</label>
                                    @error('city')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
