                            ...
                            @foreach($rooms as $room)
                                <div class="w-auto m-4">
                                    <div class="card shadow-lg rounded-4">
                                        <div class="card-body">
                                            @if($room->image)
                                                <img src="data:image/jpeg;base64,{{ base64_encode(file_get_contents(storage_path('app/public/' . $room->image))) }}" class="img-fluid mb-3 rounded-4 shadow-lg" alt="Room Image" style="max-height: 200px; object-fit: cover;">
                                            @endif
