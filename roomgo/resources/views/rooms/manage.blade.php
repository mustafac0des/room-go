                            ...
                            @foreach ($rooms as $room)
                                <div class="col-md-4 mb-4 m-3 shadow-lg rounded-4">
                                    <div class="card rounded-4">
                                        ...
                                        <div class="card-body">
                                            <img src="data:image/jpeg;base64,{{ base64_encode(file_get_contents(storage_path('app/public/' . $room->image))) }}" class="img-fluid mb-3 rounded-4 shadow-lg" alt="Room Image">
