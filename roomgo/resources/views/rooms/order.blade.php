        ...
        <div class="card rounded-4">
            <div class="row g-0">
                <div class="col-md-6 col-lg-5">
                    <img src="data:image/jpeg;base64,{{ base64_encode(file_get_contents(storage_path('app/public/' . $room->image))) }}" class="rounded-4 shadow-lg" alt="Room Image" style="width: 100%; height: 100%; object-fit: cover;" />
                </div>
