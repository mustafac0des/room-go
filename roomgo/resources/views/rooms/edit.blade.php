                ...
                <div class="col-md-6 col-lg-7 d-flex align-items-center">
                    <div class="card-body p-4 p-lg-5 text-black">
                        ...
                        <form method="POST" action="{{ route('rooms.update', $room->id) }}">
                            ...
                            <div class="form-outline mb-3">
                                <input id="city" type="text" class="form-control form-control-md @error('city') is-invalid @enderror" name="city" value="{{ old('city', $room->city) }}" required autocomplete="city" style="border: 1px solid #9a616d; color: #9a616d;">    
                                <label class="form-label mt-2 mx-2" style="color: #9A616D;" for="city">{{ __('City') }}</label>
                                @error('city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
